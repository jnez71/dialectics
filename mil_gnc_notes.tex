...
$$
\orange{z} = h(\blue{x}, \red{\epsilon})
$$

where $\orange{z}$ is the sensor measurement, $h$ is the sensor model, $\blue{x}$ is the state, and $\red{\epsilon}$ is noise. For example, a \href{http://www.siliconsensing.com/technology/mems-gyroscopes/}{gyroscope} is a device that ideally measures the angular velocity of the thing it is attached to relative to a locally inertial frame, but expressed along the gyro axes.
\begin{align*}
\orange{z_{\text{gyro}}} &= \orange{\cs{\text{gyro}}{R}_N\cs{N}{\omega}_C} + \red{\epsilon_{\text{gyro}}}\\
...
$$
\orange{z_{\text{gyro}}} = \cs{\text{gyro}}{R}_C(\blue{R}^{\tr}\green{\cs{N}{R^{\black{\tr}}}_E\cs{N}{\omega}_E} + \blue{\omega}) + \red{b_{\text{gyro}}} + \red{\epsilon_{\text{gyro}}}
$$
...
$$
\orange{z_{\text{pres}}} = \rho \cs{E}{g} \cdot (\cs{E}{r}_{\text{surf}} - \blue{p} - \blue{R}^{\tr}\cs{C}{r}_{\text{pres}}) + \red{\epsilon_{\text{pres}}}
$$
...
$$
\orange{z_{\text{mag}}} = A_{\text{mag}}\cs{\text{mag}}{R}_C \blue{R}^{\tr} \cs{E}{\Phi}(\blue{p}) + b_{\text{mag}} + \red{\epsilon_{\text{mag}}}
$$
...
$$
\orange{z_{dvl}} = \cs{\text{dvl}}{R}_C (\blue{v} + \blue{\omega} \times \cs{C}{r}_{\text{dvl}}) \cdot \cs{\text{dvl}}{\zeta}_{\text{beam}} + \red{\epsilon_{\text{dvl}}}
$$
...
$$
\orange{z_{\text{gps}}} = \blue{p} + \red{\epsilon_{\text{gps}}}
$$
...
$$
\orange{z_{\text{acc}}} = h_{\text{acc}}(\blue{x}, \dot{\blue{x}}, \red{\epsilon_{\text{acc}}}) = \cs{\text{acc}}{R}_C \blue{R}^{\tr} \green{\cs{N}{R^{\black{\tr}}}_E} \orange{\cs{N}{\ddot{r}}_{\text{acc}}} + \red{\epsilon_{\text{acc}}}
$$
...
\blue{Robot-state} | \green{Earth-state} | Constant / Operator | \red{Input / Disturbance / Noise} | \orange{Measurement}
...
\textbf{Gyroscope}
$$
\orange{z_{\text{gyro}}} = \cs{\text{gyro}}{R}_C(\blue{R}^{\tr}\green{\cs{N}{R^{\black{\tr}}}_E\cs{N}{\omega}_E} + \blue{\omega}) + \red{b_{\text{gyro}}} + \red{\epsilon_{\text{gyro}}},\ \ \ \ \dot{\red{b}}_{\text{\red{gyro}}} = \red{\epsilon_{\text{gyro\_bias}}}
$$
...
\textbf{Accelerometer}
$$
\orange{z_{\text{acc}}} = h_{\text{acc}}(\blue{x}, \dot{\blue{x}}, \red{\epsilon_{\text{acc}}}) = \cs{\text{acc}}{R}_C \blue{R}^{\tr} \green{\cs{N}{R^{\black{\tr}}}_E} \orange{\cs{N}{\ddot{r}}_{\text{acc}}} + \red{b_{\text{acc}}} + \red{\epsilon_{\text{acc}}},\ \ \ \ \dot{\red{b}}_{\text{\red{acc}}} = \red{\epsilon_{\text{acc\_bias}}}
$$
